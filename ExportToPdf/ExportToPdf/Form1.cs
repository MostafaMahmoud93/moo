...
namespace ExportToPdf
{
    public partial class Form1 : Form
    {
        ...
        DataTable MakeDataTable()
        {
            ...
            //   //  dataGrideView2.Rows[n].Cells[col, Index].value = dataGrideView1.Rows[row, Index].Cells[col, Index].Value.ToString();
            //    }
            //}
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=.;Initial Catalog=mostafa;Integrated Security=True");
